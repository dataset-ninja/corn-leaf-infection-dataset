...
##################################
PROJECT_NAME: str = "Corn Leaf Infection"
PROJECT_NAME_FULL: str = "Corn Leaf Infection Dataset"
...
HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/qramkrishna/corn-leaf-infection-dataset"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 4003551
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/corn-leaf-infection-dataset"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/qramkrishna/corn-leaf-infection-dataset/download?datasetVersionNumber=2"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {
    "classification sets": ["healthy", "infected"]
}
